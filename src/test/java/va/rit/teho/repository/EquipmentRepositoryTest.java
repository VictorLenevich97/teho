...
public class EquipmentRepositoryTest {
    ...
    public void testGetEquipmentGroupedByType() {
        ...
        Equipment equipment2 = new Equipment(2L, "equipment2", savedEquipment1.getEquipmentSubType());
        Equipment equipment3 = new Equipment(3L, "equipment3", new EquipmentSubType("short2",
                                                                                    "full2",
        ...
        Map<EquipmentSubType, List<Equipment>> firstSubTypeMap = equipmentGroupedByType.get(savedEquipment1
                                                                                                    .getEquipmentSubType()
                                                                                                    .getEquipmentType());
        Assertions.assertEquals(1, firstSubTypeMap.size());
        List<Equipment> firstEquipmentList = firstSubTypeMap.get(savedEquipment1.getEquipmentSubType());
        ...
        Map<EquipmentSubType, List<Equipment>> secondSubTypeMap = equipmentGroupedByType.get(savedEquipment3
                                                                                                     .getEquipmentSubType()
                                                                                                     .getEquipmentType());
    ...
    public void testGetEquipmentGroupedByTypeFilterById() {
        ...
        Map<EquipmentType, Map<EquipmentSubType, List<Equipment>>> equipmentGroupedByType =
                equipmentRepository.getEquipmentGroupedByType(Collections.singletonList(savedEquipment1.getId()),
                                                              null,
                                                              null);
