...
@Controller
@RequestMapping(path = "repair-formation", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
@Api(tags = "РВО")
public class RepairFormationController {
    ...
    public ResponseEntity<List<RepairFormationUnitDTO>> listRepairFormationUnits(
        ...
        List<RepairFormationUnitDTO> repairFormationUnitDTOList =
                repairFormationService.listUnits(Optional.ofNullable(ids).orElse(Collections.emptyList()),
                                                 pageNum,
                                                 pageSize)
                                      .stream()
    ...
    @GetMapping("/{repairFormationUnitId}")
    @ResponseBody
    @ApiOperation(value = "Получить детальные данные по РВО")
    public ResponseEntity<RepairFormationUnitDTO> getRepairFormationUnit(@ApiParam(value = "Ключ РВО", required = true) @PathVariable Long repairFormationUnitId) {
        Pair<RepairFormationUnit, List<RepairFormationUnitEquipmentStaff>> repairFormationUnitListPair =
                repairFormationService.getUnitWithStaff(repairFormationUnitId, tehoSession.getSessionId());
    ...
    @PutMapping("/{repairFormationUnitId}")
    ...
    public ResponseEntity<TableDataDTO<Map<String, RepairFormationUnitEquipmentStaffDTO>>> getEquipmentStaff(
        ...
        Map<RepairFormationUnit, Map<EquipmentSubType, RepairFormationUnitEquipmentStaff>> repairFormationUnitEquipmentStaff =
                repairFormationService.getRepairFormationUnitEquipmentStaffGrouped(tehoSession.getSessionId(),
    ...
    @PutMapping("/{repairFormationUnitId}/staff")
    @ApiOperation(value = "Обновление информации по личному составу РВО")
    public ResponseEntity<Object> updateRepairFormationUnitEquipmentStaff(@ApiParam(value = "Ключ РВО", required = true) @PathVariable Long repairFormationUnitId,
                                                                         @ApiParam(value = "Данные по численности л/с", required = true) @RequestBody Map<Long, RepairFormationUnitEquipmentStaffDTO> staff) {
        repairFormationService.updateUnitEquipmentStaff(
                staff
                        .entrySet()
                        .stream()
