...
public interface EquipmentPerBaseFailureIntensityRepository
    ...
    @Query("SELECT new va.rit.teho.entity.equipment.EquipmentPerBaseFailureIntensityAndLaborInput(epbfi.base.id, epbfi.equipment.id, epbfi.stage.id, epbfi.repairType.id, epbfi.intensityPercentage, epbfi.avgDailyFailure, elipt.amount) FROM " +
